...
if (not no_copi_override) and copisThingsInstalled and not copisThingsEnabled then
    ...
    ModLuaFileAppend("mods/ImmersiveMimics/init.lua", table.concat{"mods/", selectedMod, "/init.lua"})
    if(ModTextFileGetContent(table.concat{"mods/", selectedMod, "/settings.lua"}) ~= nil) then
        ModLuaFileAppend("mods/ImmersiveMimics/settings.lua", table.concat{"mods/", selectedMod, "/settings.lua"})
    end
else
    --[=[
    ...
    ModLuaFileAppend("mods/ImmersiveMimics/init.lua", "mods/ImmersiveMimics/translations.lua")
    ModLuaFileAppend("mods/ImmersiveMimics/init.lua", "mods/ImmersiveMimics/append.lua")
end